...
-- Which Discount users spending above average?
...
--which 5 purchase have the highest percentage of purchases with discounts applied?
...
--Segment customers into New,Returning,and Loyal based on their total no of 
...
--are customers who are repeat buyers(more than 5 prev purchases) also 
--likely to subscribe?
